...
public class DatabaseManager
{
  ...
  {
    Map<String, PlaceInfo> placeList = new HashMap<>();
    String selectQuery = "SELECT idx, category, title, address, lat, lng, image, offlineimage FROM " + "place WHERE (lat BETWEEN '" + botomLat + "' AND '" + topLat + "') " + " AND (lng BETWEEN '"
        + bottomLng + "' AND '" + topLng + "')";
