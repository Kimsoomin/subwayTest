...
public class BoundedMapView extends MapView 
{
	...
	public BoundedMapView(Context arg0, int arg1, ResourceProxy arg2,
...
//        Log.e("DEBUG", "ZOOM LEVEL: " + nLastZoomLevel + "  [MAP SIZE] " + worldSize_2);
        ...
        // Get NW/upper-left
        final Point upperLeft = TileSystem.LatLongToPixelXY((box.getLatNorthE6() - nLatitudeOffset) / 1E6,
                                                            (box.getLonWestE6() - nLongitudeOffset) / 1E6,
                                                            nLastZoomLevel,
                                                            null);        
...
//        Log.e("DEBUG", "upperLeft = " + upperLeft);
        ...
        // Get SE/lower-right
        final Point lowerRight = TileSystem.LatLongToPixelXY((box.getLatSouthE6() + nLatitudeOffset) / 1E6,
                                                             (box.getLonEastE6() + nLongitudeOffset) / 1E6,
                                                             nLastZoomLevel,
                                                             null);
