...
public class TicketListAdapter extends BaseAdapter
{
  ...
  public View getView(int position, View convertView, ViewGroup parent)
  {
    ...
    priceWon.setText(parent.getContext().getString(R.string.won) + NumberFormatter.addComma(bean.priceWon));
    priceYuan.setText("(" + parent.getContext().getString(R.string.yuan) + NumberFormatter.addComma(bean.priceYuan) + ")");
    return view;
  }
}
