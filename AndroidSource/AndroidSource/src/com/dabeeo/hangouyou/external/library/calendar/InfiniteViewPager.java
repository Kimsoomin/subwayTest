package com.dabeeo.hangouyou.external.library.calendar;
...
public class InfiniteViewPager extends ViewPager
{
  ...
  /**
   * ViewPager does not respect "wrap_content". The code below tries to measure
   * the height of the child and set the height of viewpager based on child
   * height It was customized from
   * http://stackoverflow.com/questions/9313554/measuring-a-viewpager Thanks
   * Delyan for his brilliant code
   */
  @Override
  protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec)
  {
    ...
    {
      /*
       * The first super.onMeasure call made the pager take up all the available
       * height. Since we really wanted to wrap it, we need to remeasure it.
       * Luckily, after that call the first child is now available. So, we take
       * the height from it.
       */
      ...
      /*
       * If the pager actually has any children, take the first child's height
       * and call that our own
       */
      if (getChildCount() > 0)
      {
        ...
        /*
         * The child was previously measured with exactly the full height. Allow
         * it to wrap this time around.
         */
    ...
    { // Otherwise we return correct number of rows
