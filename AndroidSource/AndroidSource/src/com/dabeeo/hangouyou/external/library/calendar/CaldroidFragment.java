...
public class CaldroidFragment extends DialogFragment
{
  ...
  /**
   * To use SquareTextView to display Date cell.By default, it is true, however
   * in many cases with compact screen, it can be collapsed to save space
   */
  ...
  /**
   * Set month and year for the calendar. This is to avoid naive implementation
   * of manipulating month and year. All dates within same month/year give same
   * result
   *
   * @param date
   */
  ...
  /**
   * Clear all disable dates. Notice this does not refresh the calendar, need to
