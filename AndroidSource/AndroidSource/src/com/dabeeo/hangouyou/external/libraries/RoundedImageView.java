/*
 * Copyright (C) 2015 Vincent Mi Licensed under the Apache License, Version 2.0
...
public class RoundedImageView extends ImageView
{
  ...
  private void updateAttrs(Drawable drawable)
  {
    ...
    {
      ((RoundedDrawable) drawable).setScaleType(mScaleType).setCornerRadius(cornerRadius).setBorderWidth(borderWidth).setBorderColor(borderColor).setOval(isOval).setTileModeX(tileModeX).setTileModeY(
          tileModeY);
      applyColorMod();
    }
