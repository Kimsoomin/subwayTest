...
public class DragSortController extends SimpleFloatViewManager implements View.OnTouchListener, GestureDetector.OnGestureListener
{
    ...
    *           The DSLV instance
    * @param dragHandleId
    *           The resource id of the View that represents the drag handle in a
    *           list item.
    */
   ...
   /**
    * Enable/Disable list item sorting. Disabling is useful if only item removal
    * is desired. Prevents drags in the vertical direction.
    * 
    * @param enabled
   ...
   /**
    * Set the resource id for the View that represents the drag handle in a list
    * item.
    * 
    * @param id
    ...
    * @return The list position to drag if a drag-init gesture is detected; MISS
    *         if unsuccessful.
    */
    ...
    * {@link #setDragHandleId(int)}), and returns that item's position if a drag
    * handle touch was detected.
    * 
    * @param ev
    *           The ACTION_DOWN MotionEvent.
