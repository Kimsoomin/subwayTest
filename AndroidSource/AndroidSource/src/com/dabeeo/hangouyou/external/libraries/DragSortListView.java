...
package com.dabeeo.hangouyou.external.libraries;
...
public class DragSortListView extends ListView
{
    ...
    * subtle. What this actually means is that, if enabled, the floating View
    * can be dragged below its starting position. Remove in favor of
   ...
   public DragSortListView(Context context, AttributeSet attrs)
   {
      ...
      if (attrs != null)
      {
         ...
         if (useDefault)
         {
            ...
            int bgColor = a.getColor(R.styleable.DragSortListView_float_background_color, Color.parseColor("#77FF0A0A"));
    ...
    *         of the list; that is, for when top of item at position has y-coord
    *         of given `top`). If floating View (treated as horizontal line) is
    ...
    * {@link #startDrag(int,View,int,int,int)} after obtaining the floating View
    ...
    * @return True if the drag was started, false otherwise. This
    *         <code>startDrag</code> will fail if we are not currently in a
    *         touch event, <code>floatView</code> is null, or there is a drag in
    *         progress.
    */
   ...
   public interface FloatViewManager
   {
       ...
       *           The floating View.
       * @param location
       *           The location (top-left; relative to DSLV top-left) at which
       *           the float View would like to appear, given the current touch
